...
jQuery.event = {
	...
	special: {
		...
		click: {
			...
			trigger: function() {
				if ( jQuery.nodeName( this, "input" ) && type === "checkbox" && click ) {
					click();
					return false;
				}
			},
	...
	jQuery.event.special.submit = {
		...
		postDispatch: function( event ) {
			...
			if ( event._submitBubble ) {
				...
				if ( parentNode && !event.isTrigger ) {
					jQuery.event.simulate( "submit", parentNode, event );
				}
			}
		},
...
if ( !support.change ) {
	...
	jQuery.event.special.change = {
			...
			if ( rformElems.test( nodeName ) ) {
				...
				if ( type === "checkbox" || type === "radio" ) {
					...
					jQuery.event.add( this, "click._change", function( event ) {
						if ( _justChanged && !event.isTrigger ) {
							_justChanged = false;
						}
			...
			jQuery.event.add( this, "beforeactivate._change", function( e ) {
				...
				if ( rformElems.test( elem.nodeName ) && !jQuery._data( elem, "change" ) ) {
					jQuery.event.add( elem, "change._change", function( event ) {
						if ( parentNode && !event.isSimulated && !event.isTrigger ) {
							jQuery.event.simulate( "change", parentNode, event );
						}
					} );
		...
		teardown: function() {
			...
			return !rformElems.test( nodeName );
		}
	};
}
