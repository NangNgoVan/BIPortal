...
namespace BIPortal.Models.UI
{
    ...
    public class PageModel
    {
        ...
        public void SetLanguage(Object languageObject)
        {
            ...
            this.Title = BIPortal.Helpers.Utility.JTokenHelper.GetElementLanguage(languageObject, "pages." + this.PageName + ".title");
        }
        ...
        public string GetElementByPath(string path)
        {
            ...
            output = BIPortal.Helpers.Utility.JTokenHelper.GetElementLanguage(_languageObject, "pages." + this.PageName + "." + path);
            return output;
        }
